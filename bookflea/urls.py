...
from bookstore.views import HomeView, UpdateBookView, ItemCreateView, ItemCategoryView, ItemDetail, UpdateItemCategoryView, DetailItemCategoryView, CategotyDetailView
